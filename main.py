...
from funcions_arduino import iniciar_board, arduino_info
from calibrar import calibrar
from dibuixar_trajecte import dibuixar_trajecte, guardar_path, llegir_path
from fer_trajecte import fer_trajecte
